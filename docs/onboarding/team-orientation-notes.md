...
- **My fork (created in Step 3):** https://github.com/info3330ib/PREIShare-org-repo
...
PREIshare takes real-estate data from many different sources, documenting property, market trends, sales, things of that sort to help people make an educated decision when dealing with buying or selling property.
...
These are some good notes, I need to remember to make commits to a branch, there needs to be PR with review then it can finally merge to production.
